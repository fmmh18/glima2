          ...
          <form action="<?php echo getenv('APP_HOST').'/admin/vaga/adicionar'; ?>" method="post">
            <div class="row">
               ...
               <label for="pagina">Página</label>
                <input type="text" class="form-control" name="page_name" id="pagina"> 
               </div>
               <div class="col">
                <label for="tag">Tag</label>
                <input type="text" class="form-control" name="page_tag" id="tag">
                </div>
            </div>
            <div class="row">
            <div class="col">
                <label for="conteudo">Conteúdo</label>
                <textarea name="page_html" id="conteudo" class="form-control" cols="30" rows="10"></textarea>
            </div>
            </div>
            <div class="row mt-2">
                <div class="col">
