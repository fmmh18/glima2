...
<div class="container-fluid">
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row">
          ...
          <form action="<?php echo getenv('APP_HOST').'/admin/servico/adicionar'; ?>" method="post" enctype="multipart/form-data"> 
            <div class="row">
               <div class="col">
            ...
            <div class="col">
                ...
                <textarea name="service_description" id="conteudo" class="form-control" cols="30" rows="10"></textarea>
            </div>
            </div>
            <div class="row mt-2">
                <div class="col">
